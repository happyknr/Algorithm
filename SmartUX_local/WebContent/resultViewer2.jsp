...
%>
		$("#packageNameForm").attr({action:'resultViewer2.jsp', method:'post'}).submit();
	}
...
<%
	//	Iterator<String> iterator = packageNameOption.keySet().iterator();
...
<div id="frameDiv" style="display: none;">
	...
	<iframe name="fileReader" width="100%" height="800" scroll="no" src="xlsxFileReader.jsp" frameBorder="0"></iframe>
</div>	
</body>
</html>